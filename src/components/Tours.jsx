const tours = [
  ...
  },
  {
    ...
    cta: 'התחילו סיור עצמאי',
  },
]

export default function Tours() {
  return (
    <section id="tours" className="py-24" style={{ background: 'linear-gradient(180deg, rgba(237,224,196,0.55) 0%, rgba(245,237,214,0.58) 100%)' }}>
