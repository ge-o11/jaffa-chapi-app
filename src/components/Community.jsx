const steps = [
  { num: '01', title: 'סרקו QR / NFC', desc: 'בכל נקודת אטרקציה ביפו העתיקה יש מעמד QR/NFC. סרקו ותיכנסו ישירות לקהילה.' },
  { num: '02', title: 'הצטרפות לקהילה', desc: 'הצטרפו לקהילת הוואצ\'אפ השקטה של יפו העתיקה — מקבלים עדכונים בלבד.' },
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center">
          <a href="https://chat.whatsapp.com/BhnFkwONJd6DeA7KlwG1MC" target="_blank" rel="noreferrer" className="btn-whatsapp text-xl py-5 px-10 rounded-2xl pulse-ring">
            ...
            הצטרפו עכשיו — קבלו 10 נקודות מיידית
          </a>
        </div>
      </div>
    </section>
