...
export default function Community() {
  return (
    <section id="community" className="py-24" style={{ background: 'linear-gradient(180deg, #0D1B2A 0%, #0f2233 100%)' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center">
          <a href="https://chat.whatsapp.com/JAFFA" target="_blank" rel="noreferrer" className="btn-whatsapp text-xl py-5 px-10 rounded-2xl pulse-ring">
