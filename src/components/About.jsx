    ...
    <section id="about" className="py-12 md:py-16">
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg md:text-xl font-medium mb-2" style={{ color: '#1A6B8A' }}>
            חוויות פעילות ביפו העתיקה
          </p>
          <p className="text-sm md:text-base max-w-2xl mx-auto" style={{ color: '#0D3A56', opacity: 0.85 }}>
        ...
        <div className="rounded-3xl p-6 md:p-10 mb-10 text-right"
          ...
          <p className="text-base md:text-lg leading-relaxed font-bold" style={{ color: '#1A6B8A' }}>
            במקום ליצור אובייקט אמנותי מנותק, אני יוצר חיבור חי בין המבקר, המקום, העסקים והסיפור של יפו העתיקה.
          </p>
        </div>
